...
> **Implementation state:** Current — decisions reflect actual architecture
...
- `03-engineering/03-integration.md`
...
- `01-foundation/03-product-spec.md` §16
...
- Tất cả 9 MVP feature từ `01-foundation/03-product-spec.md` §17 được demo
...
- `03-engineering/04-security-and-permissions.md`
...
- `03-engineering/03-integration.md` (SePay/SHB webhook)
...
- `01-foundation/03-product-spec.md`
